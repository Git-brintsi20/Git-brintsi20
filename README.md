<div align="center">
  <a href="mailto:shiki2hustle@gmail.com">
    <img src="./.github/open-to-work-gradient.svg" alt="Open to Work"/>
  </a>
</div>
...
<div align="center">
  <h1>Hi, I'm Salugu Harshita Bhanu 👋</h1>
  <p><em>I build full-stack systems that are secure by default and useful by design - from AI healthcare tools to real-time event orchestration.</em></p>
  <br/>
  ...
  <br/><br/>
  <img src="https://img.shields.io/badge/🛡️_Build-Secure_Products-0EA5E9?style=for-the-badge" alt="Build secure products" />
  <img src="https://img.shields.io/badge/🎯_Focus-Real_User_Problems-A855F7?style=for-the-badge" alt="Focus on user problems" />
  <img src="https://img.shields.io/badge/⚡_Approach-Ship_Fast_%26_Iterate-F97316?style=for-the-badge" alt="Ship fast and iterate" />
</div>
...
<p align="center">💻 Full-stack developer who approaches every project as both a <b>dev and a user</b> - because every good project solves a real problem for a real person.</p>
<p align="center">🔐 Cybersecurity enthusiast exploring ethical hacking and security research.</p>
<p align="center">🤖 Actively diving into <b>AI/ML and Generative AI</b> while exploring CRM systems architecture.</p>
<p align="center">🏆 Hackathon builder - shipped real products under 36-hour sprints.</p>
<p align="center">⚡ CGPA: <b>8.4</b> - IIIT Jabalpur, B.Tech CSE (2027).</p>
...
![Backend Internships](./.github/gradient-badges/backend-internships-open.svg)
![Full-Stack Internships](./.github/gradient-badges/fullstack-internships-open.svg)
![AI Internships](./.github/gradient-badges/ai-internships-open.svg)
![SDE Roles](./.github/gradient-badges/sde-roles-open.svg)
![Open Source Contributions](./.github/gradient-badges/open-source-contributions.svg)
...
<table>
  <tr>
    <td align="left" width="24%"><b>Languages</b></td>
    <td align="left">
  ...
  <tr>
    <td align="left"><b>Databases and Caching</b></td>
    <td align="left">
  ...
  <tr>
    <td align="left"><b>AI, ML and Cloud</b></td>
    <td align="left">
  ...
  <tr>
    <td align="left"><b>APIs and Integration</b></td>
    <td align="left">
  ...
  <tr>
    <td align="left"><b>CRM and ERP</b></td>
    <td align="left">
      <img src="https://img.shields.io/badge/Zoho_CRM-E42527?style=flat-square&logo=zoho&logoColor=white" alt="Zoho CRM" />
      <img src="https://img.shields.io/badge/ERPNext-0089FF?style=flat-square&logo=frappe&logoColor=white" alt="ERPNext" />
    </td>
  </tr>
  <tr>
    <td align="left"><b>DevOps and Tools</b></td>
    <td align="left">
  ...
  <tr>
    <td align="left"><b>Security Tools</b></td>
    <td align="left">
...
<h3 align="center">🐞 Bug Tracker SaaS</h3>
<p align="center"><b>CRM-style bug tracking and project lifecycle platform</b></p>
...
<p align="center">• 3 independently deployable microservices: Auth, Bug Management, Notifications</p>
<p align="center">• Real-time WebSocket notifications for create/update/assign/comment events</p>
<p align="center">• Full bug lifecycle: Open -> In Progress -> Resolved -> Closed</p>
<p align="center">• Redis caching delivered ~40% performance improvement</p>
...
<h3 align="center">🛡️ CipherSuite</h3>
<p align="center"><b>All-in-one enterprise cybersecurity suite</b></p>
...
<p align="center">• AES-256-GCM encrypted password vault with secure drag-and-drop file storage</p>
<p align="center">• TOTP 2FA with QR setup and backup code support</p>
<p align="center">• ML anomaly detection with Isolation Forest session scoring (0-100)</p>
<p align="center">• Real TCP network and port scanner with vulnerability analysis</p>
...
<p align="center">🥈 <b>HackByte 3.0 - Top 8 of 126 Teams</b></p>

<p align="center">• CNN model trained on 87,601 images with 98% accuracy</p>
<p align="center">• Gemini-powered multilingual chatbot for context-aware care advice</p>
<p align="center">• Smart reminders, care scheduling, and real-time plant health avatars</p>
...
<h3 align="center">🥗 HealthyME</h3>
<p align="center"><b>AI nutrition PWA with offline-first UX</b></p>
...
<p align="center">• AI nutrition analysis with myth-debunking backed by cited sources</p>
<p align="center">• Multi-food image recognition with per-item nutrition breakdown</p>
<p align="center">• Real-time sync with offline capability using Firebase</p>
<p align="center">• Interactive dashboards with macro charts and calorie trends</p>
...
<h3 align="center">⚡ ELIXA - AI Event Orchestration</h3>
<p align="center"><b>AI-powered command center for hackathons, fests, and conferences</b></p>
...
<p align="center">🏆 <b>HackByte 4.0 - MongoDB Track Winner (MLH) - Best Database Schema Design and MongoDB Usage</b></p>

<p align="center">• Converts plain-English event goals into structured, dependency-aware execution plans</p>
<p align="center">• Role-based access codes with real-time task state synchronization across teams</p>
<p align="center">• 3-layer persistence: SpacetimeDB WebSocket -> Relay HTTP -> MongoDB fallback</p>
<p align="center">• Go/No-Go readiness gates with voice announcements and live activity feed</p>
...
<h2 align="center">🏆 Achievements & Competitive Profiles</h2>
